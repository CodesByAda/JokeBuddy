...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('christmas-joke')
        .setDescription('Your buddy will find you one christmas joke'),
    async execute(interaction) {
        const amount = interaction.options.getInteger('count') || 1;

        const jokeUrl = `https://v2.jokeapi.dev/joke/Christmas?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&amount=${amount}`;
